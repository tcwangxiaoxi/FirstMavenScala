...
class DAGScheduler(
  ...
  private def submitMissingTasks(stage: Stage, jobId: Int) {
    ...
    // event.
    logInfo("======================== outputCommitCoordinator.stageStart starting ==========================================")
    stage match {
    ...
    logInfo("======================== outputCommitCoordinator.stageStart ending ==========================================")
    ...
    logInfo("======================== closureSerializer.serialize starting ==========================================")
    ...
    try {
      ...
      logInfo("======================== closureSerializer.serialize ending ==========================================")

      taskBinary = sc.broadcast(taskBinaryBytes)
      logInfo("======================== sc.broadcast(taskBinaryBytes) ending ==========================================")
