...
class BlockManagerMasterEndpoint(
  ...
  override def receiveAndReply(context: RpcCallContext): PartialFunction[Any, Unit] = {
    ...
    blockManagerId, blockId, storageLevel, deserializedSize, size, externalBlockStoreSize) =>
      logInfo("==========================wangxiaoxi 开始 UpdateBlockInfo=====================================")
      try {
      ...
      logInfo("==========================wangxiaoxi 结束 UpdateBlockInfo=====================================")
  ...
  private def updateBlockInfo(
    ...
    logInfo("===================== updateBlockInfo starting ===========================")

    if (!blockManagerInfo.contains(blockManagerId)) {
      if (blockManagerId.isDriver && !isLocal) {
        // We intentionally do not register the master (except in local mode),
        // so we should not indicate failure.
        logInfo("=====================blockManagerId.isDriver && !isLocal===========================")
        return true
      } else {
        logInfo("=====================else===========================")
        return false
    ...
    if (blockId == null) {
      logInfo("=====================blockId == null===========================")
      blockManagerInfo(blockManagerId).updateLastSeenMs()
      return true
    }


    logInfo("===================== blockManagerInfo(blockManagerId).updateBlockInfo starting ===========================")

    blockManagerInfo(blockManagerId).updateBlockInfo(
      blockId, storageLevel, memSize, diskSize, externalBlockStoreSize)

    logInfo("===================== blockManagerInfo(blockManagerId).updateBlockInfo finishing ===========================")
    ...
    logInfo(s"===================== finish updateBlockInfo ===========================")
    true
  }
